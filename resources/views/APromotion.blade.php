@extends('content')
@section('option')
    <link rel="stylesheet" type="text/css" href="{{asset('css/APromotion.css')}}">
	<div class="container-fluid service-content">
		<div class="row">
			<div class="col-lg-10 col-md-10 col-sm-10 col-10 ">
				<h1 class="text-center font-weight-bold">Promotions</h1>
			</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12 tableFixHead">
						<table class="table">
							...
							<tbody>
								<tr>
									<td class="Normal" id="x1">reduction</td>
        ...
        <div class="modal fade" id="ModalCreate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="text-center" >Ajouter une promotion</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
